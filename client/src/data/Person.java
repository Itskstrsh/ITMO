...
public class Person implements Comparable<Person>, Serializable {
    ...
    public Person(int id,String name, Coordinates coordinates, Float height, EyeColor eyeColor, HairColor hairColor, Country nationality, Location location, Date creationDate) {
        this.id = id;
        this.name = name;
        this.location = location;
        this.height = height;
