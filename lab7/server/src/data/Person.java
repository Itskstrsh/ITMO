...
public class Person implements Comparable<Person>, Serializable {
    ...
    private Date creationDate; // This field cannot be null. The value of this field must be generated automatically.
    private Float height; // This field cannot be null. The value of this field must be greater than 0.
    ...
    public Person(int id,String name, Coordinates coordinates, Float height, EyeColor eyeColor, HairColor hairColor, Country nationality, Location location, String creationDate) {
        this.id = id;
        this.name = name;
        this.location = location;
        this.height = height;
